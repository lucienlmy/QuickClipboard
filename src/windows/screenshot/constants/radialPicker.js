...
// 交互
export const RADIAL_PICKER_TRIGGER_KEY = 'Tab';

// 动画
export const RADIAL_PICKER_ANIM_DURATION = 200;
export const RADIAL_PICKER_ANIM_DELAY_IN = 10;
export const RADIAL_PICKER_ANIM_DELAY_OUT = 5;
export const RADIAL_PICKER_ANIM_EXIT_WAIT = 150;
