...
function SelectionToolbar({
  ...
  longScreenshotAutoScrollDirection,
  ...
  const longScreenshotTools = [
    ...
    {
      id: 'longScreenshot-autoScrollUp',
      icon: isLongScreenshotAutoScrolling && longScreenshotAutoScrollDirection === 'up' ? 'ti ti-player-pause' : 'ti ti-chevrons-up',
      title: isLongScreenshotAutoScrolling && longScreenshotAutoScrollDirection === 'up' ? '停止向上滚动' : '向上自动滚动',
      onClick: () => onLongScreenshotToggleAutoScroll('up'),
      variant: isLongScreenshotAutoScrolling && longScreenshotAutoScrollDirection === 'up' ? 'primary' : 'default',
      disabled: isLongScreenshotSaving || !isLongScreenshotCapturing,
    },
    {
      id: 'longScreenshot-autoScrollDown',
      icon: isLongScreenshotAutoScrolling && longScreenshotAutoScrollDirection === 'down' ? 'ti ti-player-pause' : 'ti ti-chevrons-down',
      title: isLongScreenshotAutoScrolling && longScreenshotAutoScrollDirection === 'down' ? '停止向下滚动' : '向下自动滚动',
      onClick: () => onLongScreenshotToggleAutoScroll('down'),
      variant: isLongScreenshotAutoScrolling && longScreenshotAutoScrollDirection === 'down' ? 'primary' : 'default',
      disabled: isLongScreenshotSaving || !isLongScreenshotCapturing,
    },
    {
