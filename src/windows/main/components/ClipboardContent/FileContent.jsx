...
function FileContent({
  ...
  // 小行高模式：使用紧凑样式
  if (compact) {
    return <div className="w-full h-full overflow-y-auto space-y-0.5 pr-1">
        {filesData.files.map((file, index) => <div key={index} className="flex items-center gap-1.0 px-1 py-0 bg-white dark:bg-gray-900/50 rounded border border-gray-200/60 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 transition-colors h-full">
