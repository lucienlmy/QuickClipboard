  ...
  return (
    <>
      ...
      <SettingsSection
        ...
        description={t('settings.dataManagement.exportDesc')}
      >
        <SettingItem
          label={t('settings.dataManagement.exportAllData')}
          description={t('settings.dataManagement.exportAllDataDesc')}
        >
          <Button
      ...
      <SettingsSection
        ...
        description={t('settings.dataManagement.importDesc')}
      >
        <SettingItem
          label={t('settings.dataManagement.importData')}
          description={t('settings.dataManagement.importDataDesc')}
        >
          <Button
        ...
        <SettingItem
          label={t('settings.dataManagement.importMode')}
          description={t('settings.dataManagement.importModeDesc')}
        >
      ...
      {/* 数据存储位置 */}
      <SettingsSection
        title={t('settings.dataManagement.storageTitle')}
        description={t('settings.dataManagement.storageDesc')}
      >
        <SettingItem
          label={t('settings.dataManagement.currentPath')}
        ...
        <SettingItem
          label={t('settings.dataManagement.changePath')}
          description={t('settings.dataManagement.changePathDesc')}
        >
          <Button
        ...
        <SettingItem
          label={t('settings.dataManagement.resetPath')}
          description={t('settings.dataManagement.resetPathDesc')}
        >
          <Button
      ...
      {/* 数据清理 */}
      <SettingsSection
        title={t('settings.dataManagement.cleanupTitle')}
        description={t('settings.dataManagement.cleanupDesc')}
      >
        <SettingItem
          label={t('settings.dataManagement.clearHistory')}
          description={t('settings.dataManagement.clearHistoryDesc')}
        >
          <Button
        ...
        <SettingItem
          label={t('settings.dataManagement.resetSettings')}
          description={t('settings.dataManagement.resetSettingsDesc')}
        >
          <Button
        ...
        <SettingItem
          label={t('settings.dataManagement.resetAll')}
          description={t('settings.dataManagement.resetAllDesc')}
        >
          <Button
