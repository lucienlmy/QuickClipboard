...
**QuickClipboard** 是一款跨平台剪貼簿增強工具（現支援 Windows、Android），基於 Tauri 2 + Rust + React 構建。它在你複製的那一刻就開始工作——自動記錄文字、圖片、富文本、檔案，讓你隨時找回曾經複製過的任何內容。不只是記錄，QuickClipboard 還整合了截圖、貼圖、OCR、區域網路同步等能力，是日常辦公效率的全面提升。
...
| 區域網路同步        | 剪貼簿同步（文字 / 圖片）· 伺服器 / 用戶端模式 · 配對碼 / QR Code 連接 · 接收後寫入剪貼簿 · 自動重連                |
| 區域網路聊天與傳輸  | 區域網路聊天 · 檔案 / 資料夾傳送 · 線上裝置列表 · 接收確認 · 傳輸進度提示                                            |
...
| 應用過濾            | 黑白名單機制 · 僅過濾剪貼簿監聽 · 前景全域停用模式 · 程序級規則                                                     |
...
| 類型                                                      |                       說明 |                                                        下載量                                                        | 連結                                                                                                                                                                                            |
| --------------------------------------------------------- | -------------------------: | :------------------------------------------------------------------------------------------------------------------: | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **NSIS 安裝包**<br>`QuickClipboard_0.3.2_x64-setup.exe` | 推薦安裝方式，支援自動卸載 | ![下載量](https://img.shields.io/github/downloads/mosheng1/QuickClipboard/QuickClipboard_0.3.2_x64-setup.exe?label=) | [![下載 NSIS](https://img.shields.io/badge/下載-NSIS安裝包-blue?style=for-the-badge)](https://github.com/mosheng1/QuickClipboard/releases/download/v0.3.2/QuickClipboard_0.3.2_x64-setup.exe) |
| **綠色版**<br>`QuickClipboard_0.3.2.exe`                |       免安裝，雙擊即可使用 |      ![下載量](https://img.shields.io/github/downloads/mosheng1/QuickClipboard/QuickClipboard_0.3.2.exe?label=)      | [![下載綠色版](https://img.shields.io/badge/下載-綠色版-orange?style=for-the-badge)](https://github.com/mosheng1/QuickClipboard/releases/download/v0.3.2/QuickClipboard_0.3.2.exe)            |
| **可攜版**<br>`QuickClipboard_0.3.2_portable.exe`       |      更適合放隨身碟或行動使用 | ![下載量](https://img.shields.io/github/downloads/mosheng1/QuickClipboard/QuickClipboard_0.3.2_portable.exe?label=)  | [![下載可攜版](https://img.shields.io/badge/下載-可攜版-green?style=for-the-badge)](https://github.com/mosheng1/QuickClipboard/releases/download/v0.3.2/QuickClipboard_0.3.2_portable.exe)    |
| **Android 版**<br>`QuickClipboard_Android_v1.0.3.apk`    |    適用於 Android 裝置安裝 | ![下載量](https://img.shields.io/github/downloads/mosheng1/QuickClipboard/QuickClipboard_Android_v1.0.3.apk?label=)  | [![下載 Android 版](https://img.shields.io/badge/下載-Android版-success?style=for-the-badge)](https://github.com/mosheng1/QuickClipboard/releases/download/v0.3.0/QuickClipboard_Android_v1.0.3.apk)  |
